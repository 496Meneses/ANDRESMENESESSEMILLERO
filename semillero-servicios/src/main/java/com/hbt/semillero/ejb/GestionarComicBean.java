...
import com.hbt.semillero.dto.ConsultarTamañoNombreDTO;
...
public class GestionarComicBean implements IGestionarComicLocal {
	...
	@Override
	@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
	public ConsultarTamañoNombreDTO consultarComicTamanioNombre(Short leght) {
		String consulta = "SELECT new com.hbt.semillero.dto.ConsultaNombrePrecioComicDTO(c.nombre) " + " FROM Comic c";
		ConsultarTamañoNombreDTO resultado = new ConsultarTamañoNombreDTO();
		try {
			Query consultaNativa = em.createQuery(consulta);
			resultado.setNombres(consultaNativa.getResultList());
